      ...
      <div class="container">
        <div class="row">
          ...
          <div class='col-lg-6 mb-5 ftco-animate'>
            <a href='images/menu-2.jpg' class='image-popup'><img src='admin/uploads/{$proset['pro_image']}' width='400' height='400' class='img-fluid' alt='Colorlib Template'></a>
          </div>
          <div class='col-lg-6 product-details pl-md-5 ftco-animate'>
            <h3>{$proset['pro_name']}</h3>
            <p class='price'><span>  {$proset['pro_price']} $</span></p>
            <p>{$proset['pro_desc']} </p>
            <div class='row mt-4'>
              <div class='col-md-6'>
