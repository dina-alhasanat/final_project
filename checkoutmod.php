      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 ftco-animate">
	          		...
	          		<div class="cart-detail bg-light p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2"> Cach On Deliver</label>
											</div>
										</div>
									</div>
                  ...
                  <form>
									<p><a href="order.php" name="placeorder" class="btn btn-primary py-3 px-4">Place an order</a></p>
                </form>
								</div>
	          	</div>
	          </div>
