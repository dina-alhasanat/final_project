                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="Home" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="manage_admin.php">Manage Admin</a>
                                </li>
                                <li><a href="manage_customer.php">Manage Customer</a>
                                </li>
                                <li><a href="manage_product.php">Manage Product</a>
                                </li>
                                <li><a href="manage_category.php">Manage Category</a>
                                </li>
                                <li><a href="manage_order.php">Manage Order</a>
                                </li>
                                 <li><a href="manage_sec_cate.php">Manage secondary Catrgory</a>
                                </li>
                                 <li><a href="manage_sec_prod.php">Manage secondary Product</a>
                                </li>
