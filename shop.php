      ...
      <div class="container-fluid">
        <div class="row">
          ...
          echo" <div class='col-sm col-md-6 col-lg ftco-animate'>
                  <div class='product'>
                   <img src='admin/uploads/{$proset['pro_image']}' height='450' width='200' alt='Image' class='block-20'>
                   <div class='text py-3 px-3'>
                   <h3><a href='#'>{$proset['pro_name']}</a></h3>
                <div class='d-flex'>
                </div>
                <hr>
                <p class='bottom-area d-flex'>
                  <a href='single_pro.php ? id={$proset['pro_id']}' class='add-to-cart'><span>Veiw Details <i class='ion-ios-add ml-1'></i></span></a>
                </p>
              </div>
            </div>
          </div>";
