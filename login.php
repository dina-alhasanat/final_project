...
if(isset($_POST['submit'])){
    ...
    $custset = mysqli_fetch_assoc($result);

    if(isset($custset['customer_id'])){
        $_SESSION['customer_id'] = $custset['customer_id'];
      header("location:checkoutmod.php"); }
      else{
        
        $error= "user not found ,check your email & password or you have to register firstly then try to login";
       }
              ...
              <div class="form-group">
               ...
               <?php
                  if(isset($error)){
                    ...
                    echo"<div class='alert alert-danger alert-mg-b-0' role='alert'>$error</div>";
                   echo " <p class='text-center'><a href='register.php' class='btn btn-primary py-3 px-4'>Register Now>>>></a></p>";
                  }
                ?>
              </br>
               </br>
