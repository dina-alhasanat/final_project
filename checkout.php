	          ...
	          <div class='row mt-5 pt-3 d-flex'>
	          	<div class='col-md-6 d-flex'>
	          		<div class='cart-detail cart-total bg-light p-3 p-md-4'>
	          			<h3 class='billing-heading mb-4'>Your Info</h3>
	          			<p class='d-flex'>
		    						<span>Your Name</span>
		    						<span>{$custset['customer_name']}</span>
		    					</p>
		    					<p class='d-flex'>
		    						<span>Your Mobile number</span>
		    						<span>{$custset['customer_mobile']}</span>
		    					</p>
		    					<p class='d-flex'>
		    						<span>Your Address</span>
		    						<span>{$custset['customer_address']}</span>
		    					</p>
		    					<hr>
	          		...
	          		<div class="cart-detail bg-light p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2"> Cash on deliver</label>
											</div>
										</div>
									</div>
